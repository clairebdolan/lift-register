...
self.addEventListener("fetch", event => {
  ...
  // icon, the font.
  //
  // Not the photos. Those are served by Drive, so the line above sends them
  // straight out to the network and they never reach here. The browser keeps
  // its own copy for a day, which is all the offline they need and none of
  // our business. Worth knowing before going looking for them in this file.
